...
public class DeleteNotificationService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        UUID todoID = (UUID) intent.getSerializableExtra(TodoNotidicationService.TODOUUID);
    ...
    private void dataChanged() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences(MainFragment.SHARED_PREF_DATA_SET_CHANGE, MODE_PRIVATE);
