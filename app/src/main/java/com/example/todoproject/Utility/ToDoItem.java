...
public class ToDoItem implements Serializable {
    ...
    private static final String TODODESCRIPTION = "tođóecription";
    ...
    public ToDoItem(){this("Clean my room","Sweep and Mop my room", true, new Date());};
    ...
    public String getToDoText(){return mToDoText;}
    public void setmToDoText(String mToDoText){this.mToDoText = mToDoText;}
    public boolean hasReminder(){return mHasReminder;}
    public void setmHasReminder(boolean mHasReminder){this.mHasReminder = mHasReminder;}
    public Date getToDoDate(){return mToDoDate;}
    public void setToDoDate(Date mToDoDate){this.mToDoDate = mToDoDate;}
    public int getToDoColor(){return mTodoColor;}
    public void setToDoColor(int mToDoColor){this.mTodoColor = mToDoColor;}

    public UUID getIdentifier(){return mTodoIdentifier;}
}
